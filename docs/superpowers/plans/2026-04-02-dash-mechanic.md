...
- [x] **Step 1: Добавить константы и переменные рывка**
...
- [x] **Step 2: Добавить метод создания частиц дыма**
...
- [x] **Step 3: Добавить вызов `_setup_dash_particles()` в `_ready()`**
...
- [x] **Step 4: Добавить публичный метод `try_dash()`**
...
- [x] **Step 5: Добавить обработку рывка в `_physics_process()`**
...
- [x] **Step 6: Запустить проект, убедиться что ничего не сломалось**
...
- [x] **Step 1: Добавить сигнал `dash_pressed`**
...
- [x] **Step 2: Добавить обработку Shift в `_unhandled_input()`**
...
- [x] **Step 3: Блокировка ввода движения во время рывка**
...
- [x] **Step 1: Добавить ноды в hud.tscn**
...
- [x] **Step 2: Обновить hud.gd — добавить переменные и сигнал**
...
- [x] **Step 3: Подключить кнопку рывка в `_ready()`**
...
- [x] **Step 4: Добавить публичный метод обновления кулдауна**
...
- [x] **Step 5: Добавить колбек кнопки**
...
- [x] **Step 1: Подключить сигналы рывка в `_ready()`**
...
- [x] **Step 2: Добавить колбек рывка**
...
- [x] **Step 3: Запустить проект и протестировать**
