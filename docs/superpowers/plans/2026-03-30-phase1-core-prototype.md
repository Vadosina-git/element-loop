...
- [x] **Step 1: Инициализировать git-репозиторий**
...
- [x] **Step 2: Создать структуру папок**
...
- [x] **Step 3: Создать project.godot**
...
- [x] **Step 5: Создать автозагрузки-заглушки**
...
- [x] **Step 6: Установить GUT и написать тест ElementTable**
...
- [x] **Step 8: Создать .gitignore и коммит**
...
- [x] **Step 1: Написать тесты ZoneLogic**
...
- [x] **Step 3: Реализовать ZoneLogic**
...
- [x] **Step 1: Написать тесты CombatLogic**
...
- [x] **Step 3: Реализовать CombatLogic**
...
- [x] **Step 1: Создать ArenaView — сцену арены**
...
- [x] **Step 3: Создать файл сцены ArenaView.tscn вручную (минимальная структура)**
...
- [x] **Step 1: Создать PlayerCharacter**
...
- [x] **Step 2: Создать VirtualJoystick**
...
- [x] **Step 4: Создать сцену player_character.tscn**
...
- [x] **Step 5: Создать сцену virtual_joystick.tscn**
...
- [x] **Step 3: Создать сцену enemy_base.tscn**
...
- [x] **Step 2: Создать сцену hud.tscn**
...
- [x] **Step 1: Создать GameController**
...
- [x] **Step 2: Создать game_controller.tscn**
...
- [x] Эскалация (5 врагов → повышение уровней)
- [x] Все 5 архетипов врагов (Water, Tree, Earth, Metal)
- [x] Способности + лутбокс
- [x] Объекты карты: аптечка, укрытие
- [x] Босс (гибрид 2 стихий)
- [x] Полный HUD (слот способности, таймер метки)
- [x] Экран смерти + чекпоинты
- [x] Меню
- [x] Монетизация (revive, reroll)
- [x] Визуал Don't Starve стиль
- [x] Звук и музыка
- [x] Мобильный экспорт
